...
# 11/10/2018
# Interpreter: PyCharm
# Assumption: Looking in the 'vehicles' api using vehicle_class to differentiate the land vehicle.
...
def high_value(info, max_value):
    ...
    try:
        ...
        for v in info:
            ...
            if v['vehicle_class'] == 'wheeled' or v['vehicle_class'] == 'wheeled walker' \
                    or v['vehicle_class'] == 'walker' or v['vehicle_class'] == 'droid tank' \
                    or v['vehicle_class'] == 'assault walker':
...
print("{}{}".format("The highest value: ", max_value))
print("{}{}".format("The name of highest: ", name))