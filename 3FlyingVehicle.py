...
# 13/10/2018
# Interpreter: PyCharm
# Assumption: Looking at the vehicles api using vehicle_class to differentiate the flying vehicle
...
def cargo_cap(info, cargo_amount):
    for v in info:
        ...
        if v['vehicle_class'] != 'wheeled' and v['vehicle_class'] != 'wheeled walker' \
                and v['vehicle_class'] != 'walker' and v['vehicle_class'] != 'droid tank' \
                and v['vehicle_class'] != 'assault walker' and v['vehicle_class'] != 'submarine':
...
print("{}{}".format("The ascending order of cargo capacity: ", cargo_amount))
